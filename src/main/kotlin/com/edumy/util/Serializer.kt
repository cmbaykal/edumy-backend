...
object BaseResponseSerializer : KSerializer<ApiResponse<Any>> {
    override fun deserialize(decoder: Decoder): ApiResponse<Any> {
        TODO("Not yet implemented")
    }
    override fun serialize(encoder: Encoder, value: ApiResponse<Any>) {
        TODO("Not yet implemented")
    }
}